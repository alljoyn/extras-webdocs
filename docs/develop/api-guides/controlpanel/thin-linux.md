...
| Cp.xsd and cpvalidate | As part of the generation the XML undergoes two validation steps.|
...
[Build an Application using the Thin Library section][build-app-thin-library] 
for instructions.
