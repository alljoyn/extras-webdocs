...
During debugging you will want to see where in the program you are. The stack
...
the line numbers. Line numbers highlighted in red have breakpoints
set on that line. In this case there are two breakpoints set, one at line 35
