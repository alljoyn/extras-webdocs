...
|---|:-:|---|:-:|---|
| Version | `q` | [`1`, `SHRT_MAX`] | `RO` | Interface version |
| State | `n` | `OBState` | read-only | Configuration state |
| LastError | `ns` | `OBValidationState` | R/O | Last error code and message |
...
| Error | Description |
|---|---|
| `org.alljoyn.Error.OutOfRange` | `authType` is invalid |
