...
grantee can issue a certificate to others.  If cA flag is false then a peer validating a
...
- Root certificates should include the ExtendedKeyUsage values for which it is
intended to be authority of.
