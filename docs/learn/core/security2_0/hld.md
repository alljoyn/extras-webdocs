...
grantee can issue a certificate to others.  Any peer validating a
...
- The leaf certificate must have one EKU and be correct per the use case,
identity certificate EKU or membership certificate EKU.
...
- When a certificate is received during ECDHE_DSA authentication.
